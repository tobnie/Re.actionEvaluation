...
public class NotificationActor extends AbstractActor {
	...
	private void initializeExploration() {
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getV(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getY(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
		...
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getW(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
		...
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getX(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getZ(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
		explorationConsumer.put(Params6Model.Params6ModelPackage.eINSTANCE.getU(), obj -> {
			Collection<EObject> children = new LinkedList<>();
			return children;
		});
	}
