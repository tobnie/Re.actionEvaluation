...
/**
 * A match for the rule <code>P53Ubiquitination()</code>.
 */
public class P53UbiquitinationMatch extends GraphTransformationMatch<P53UbiquitinationMatch, P53UbiquitinationRule> {
	private E2 varE2;
	...
	/**
	 * Creates a new match for the rule <code>P53Ubiquitination()</code>.
	 * 
	 * @param pattern
	 *            the pattern
	 * @param match
	 *            the untyped match
	 */
	public P53UbiquitinationMatch(final P53UbiquitinationRule pattern, final IMatch match) {
		super(pattern, match);
