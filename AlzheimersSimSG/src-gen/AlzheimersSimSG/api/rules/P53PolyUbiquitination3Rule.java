...
import AlzheimersSimSG.api.matches.P53PolyUbiquitination3Match;
...
/**
 * The rule <code>P53PolyUbiquitination3()</code> which does the following:
 * If this rule is not self-explaining, you really should add some comment in the specification.
 */
public class P53PolyUbiquitination3Rule extends GraphTransformationRule<P53PolyUbiquitination3Match, P53PolyUbiquitination3Rule> {
	private static String patternName = "P53PolyUbiquitination3";

	/**
	 * Creates a new rule P53PolyUbiquitination3().
	 * 
	 * @param api
	 ...
	 *            the interpreter
	 */
	public P53PolyUbiquitination3Rule(final AlzheimersSimSGAPI api, final GraphTransformationInterpreter interpreter) {
		super(api, interpreter, patternName);
	}

	@Override
	protected P53PolyUbiquitination3Match convertMatch(final IMatch match) {
		return new P53PolyUbiquitination3Match(this, match);
	}
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindE2(final E2 object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindUbis(final UBI_s object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindMdm2(final Mdm2 object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindP53(final P53 object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindUs(final U_s object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindUb3s(final UB3_s object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindUnbs(final UNB_s object) {
	 ...
	 *            the object to set
	 */
	public P53PolyUbiquitination3Rule bindUb4s(final UB4_s object) {
