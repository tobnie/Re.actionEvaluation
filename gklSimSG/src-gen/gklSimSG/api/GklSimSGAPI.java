...
import gklSimSG.api.rules.KT_xBwdRule;
import gklSimSG.api.rules.KT_xRule;
import gklSimSG.api.rules.KT_yBwdRule;
...
import gklSimSG.api.rules.P_a_T_yBoundSrcRule;
...
import gklSimSG.api.rules.T_x_K_aBoundSrcRule;
import gklSimSG.api.rules.T_x_K_aBoundTrgRule;
import gklSimSG.api.rules.T_y_K_aBoundSrcRule;
import gklSimSG.api.rules.T_y_K_aBoundTrgRule;
import gklSimSG.api.rules.Tp_xRule;
import gklSimSG.api.rules.Tp_yRule;
import gklSimSG.api.rules.Tu_xRule;
import gklSimSG.api.rules.Tu_yRule;
...
/**
 * The GklSimSGAPI with 22 rules.
 */
public class GklSimSGAPI extends GraphTransformationAPI {
	public static String patternPath = "gklSimSG/src-gen/gklSimSG/api/ibex-patterns.xmi";

	/**
	 * Creates a new GklSimSGAPI.
	 *
	 * @param engine
	 ...
	 */
	public GklSimSGAPI(final IContextPatternInterpreter engine, final ResourceSet model, final String workspacePath) {
		super(engine, model);
	 ...
	 *            relative path to the patterns
	 */
	public GklSimSGAPI(final IContextPatternInterpreter engine, final ResourceSet model, final Resource defaultResource,
