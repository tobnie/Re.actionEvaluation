...
public class T_T_x_p_0_reference extends AbstractActor {
	...
	private Map<GKL1600Model.P_s, Set<EdgeMatch>> targetElements = new HashMap<GKL1600Model.P_s, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<GKL1600Model.P_s, Set<GKL1600Model.T>> pending = new HashMap<>();
	...
	private void addMatch(InputMessage message, GKL1600Model.T source, GKL1600Model.P_s target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((GKL1600Model.P_s) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<GKL1600Model.T> message) {
		...
		GKL1600Model.P_s target = (GKL1600Model.P_s) message.input.getT_x_p();
	...
	private void rightAdded(NodeAddedRight<GKL1600Model.P_s> message) {
	...
	private void rightRemoved(NodeDeletedRight<GKL1600Model.P_s> message) {
	...
	private void addReference(ReferenceAdded<GKL1600Model.T, GKL1600Model.P_s> message) {
	...
	private void removeReference(ReferenceDeleted<GKL1600Model.T, GKL1600Model.P_s> message) {
