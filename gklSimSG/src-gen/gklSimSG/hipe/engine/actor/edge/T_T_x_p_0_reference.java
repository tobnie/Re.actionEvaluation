...
public class T_T_x_p_0_reference extends AbstractActor {
	...
	private Map<GKL800Model.P_s, Set<EdgeMatch>> targetElements = new HashMap<GKL800Model.P_s, Set<EdgeMatch>>();
	private HiPESet<EdgeMatch> matches = new HiPESet<>();
	
	private Map<GKL800Model.P_s, Set<GKL800Model.T>> pending = new HashMap<>();
	...
	private void addMatch(InputMessage message, GKL800Model.T source, GKL800Model.P_s target) {
	...
	private void addPendingMatch(Object source, Object target) {
		...
		if(sourcePending == null) {
			...
			pending.put((GKL800Model.P_s) target, sourcePending);
		}
	...
	private void leftAdded(NodeAddedLeft<GKL800Model.T> message) {
		...
		GKL800Model.P_s target = (GKL800Model.P_s) message.input.getT_x_p();
	...
	private void rightAdded(NodeAddedRight<GKL800Model.P_s> message) {
	...
	private void rightRemoved(NodeDeletedRight<GKL800Model.P_s> message) {
	...
	private void addReference(ReferenceAdded<GKL800Model.T, GKL800Model.P_s> message) {
	...
	private void removeReference(ReferenceDeleted<GKL800Model.T, GKL800Model.P_s> message) {
