...
public class T_object_SP1 extends AbstractActor {
	...
	public void initActor(InitActor m) {
		...
		ports.add(new PortNodeMatchRight<GKL1600Model.T>(getSelf(), name2actor.get("KT_x_25_junction"), this::returnTrue));
		ports.add(new PortNodeMatchRight<GKL1600Model.T>(getSelf(), name2actor.get("PT_y_67_junction"), this::returnTrue));
		ports.add(new PortNodeRight<GKL1600Model.T>(getSelf(), name2actor.get("P_P_a_T_y_0_reference"), this::returnTrue));
		ports.add(new PortNodeLeft<GKL1600Model.T>(getSelf(), name2actor.get("T_T_y_u_0_reference"), this::returnTrue));
	}
