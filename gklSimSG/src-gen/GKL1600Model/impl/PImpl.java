 ...
 * </p>
 * <ul>
 *   <li>{@link GKL1600Model.impl.PImpl#getP_a_T_x <em>PaTx</em>}</li>
 *   <li>{@link GKL1600Model.impl.PImpl#getP_a_T_y <em>PaTy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PImpl extends AgentImpl implements P {
	...
	protected EClass eStaticClass() {
		return GKL1600ModelPackage.Literals.P;
	}
		...
		if (p_a_T_x != null && p_a_T_x.eIsProxy()) {
			...
			if (p_a_T_x != oldP_a_T_x) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL1600ModelPackage.P__PATX, oldP_a_T_x,
							p_a_T_x));
			}
		}
		return p_a_T_x;
	...
	public void setP_a_T_x(T newP_a_T_x) {
		...
		p_a_T_x = newP_a_T_x;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL1600ModelPackage.P__PATX, oldP_a_T_x, p_a_T_x));
	}
	...
	public T getP_a_T_y() {
		if (p_a_T_y != null && p_a_T_y.eIsProxy()) {
			...
			if (p_a_T_y != oldP_a_T_y) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL1600ModelPackage.P__PATY, oldP_a_T_y,
							p_a_T_y));
			}
		}
		return p_a_T_y;
	...
	public void setP_a_T_y(T newP_a_T_y) {
		...
		p_a_T_y = newP_a_T_y;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL1600ModelPackage.P__PATY, oldP_a_T_y, p_a_T_y));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GKL1600ModelPackage.P__PATX:
			if (resolve)
				return getP_a_T_x();
			return basicGetP_a_T_x();
		case GKL1600ModelPackage.P__PATY:
			if (resolve)
				return getP_a_T_y();
