 ...
 * </p>
 * <ul>
 *   <li>{@link UNTITLEDModel.impl.PImpl#getP_a_T_x <em>PaTx</em>}</li>
 *   <li>{@link UNTITLEDModel.impl.PImpl#getP_a_T_y <em>PaTy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PImpl extends AgentImpl implements P {
	...
	protected EClass eStaticClass() {
		return UNTITLEDModelPackage.Literals.P;
	}
		...
		if (p_a_T_x != null && p_a_T_x.eIsProxy()) {
			...
			if (p_a_T_x != oldP_a_T_x) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UNTITLEDModelPackage.P__PATX, oldP_a_T_x,
							p_a_T_x));
			}
		}
		return p_a_T_x;
	...
	public void setP_a_T_x(T newP_a_T_x) {
		...
		p_a_T_x = newP_a_T_x;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNTITLEDModelPackage.P__PATX, oldP_a_T_x, p_a_T_x));
	}
	...
	public T getP_a_T_y() {
		if (p_a_T_y != null && p_a_T_y.eIsProxy()) {
			...
			if (p_a_T_y != oldP_a_T_y) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UNTITLEDModelPackage.P__PATY, oldP_a_T_y,
							p_a_T_y));
			}
		}
		return p_a_T_y;
	...
	public void setP_a_T_y(T newP_a_T_y) {
		...
		p_a_T_y = newP_a_T_y;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UNTITLEDModelPackage.P__PATY, oldP_a_T_y, p_a_T_y));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UNTITLEDModelPackage.P__PATX:
			if (resolve)
				return getP_a_T_x();
			return basicGetP_a_T_x();
		case UNTITLEDModelPackage.P__PATY:
			if (resolve)
				return getP_a_T_y();
