...
import GKL800Model.GKL800ModelFactory;
 ...
 * @generated
 */
public class GKL800ModelPackageImpl extends EPackageImpl implements GKL800ModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see GKL800Model.GKL800ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GKL800ModelPackageImpl() {
		super(eNS_URI, GKL800ModelFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link GKL800ModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GKL800ModelPackage init() {
		if (isInited)
			return (GKL800ModelPackage) EPackage.Registry.INSTANCE.getEPackage(GKL800ModelPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredGKL800ModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GKL800ModelPackageImpl theGKL800ModelPackage = registeredGKL800ModelPackage instanceof GKL800ModelPackageImpl
				? (GKL800ModelPackageImpl) registeredGKL800ModelPackage
				: new GKL800ModelPackageImpl();
		...
		theGKL800ModelPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GKL800ModelPackage.eNS_URI, theGKL800ModelPackage);
		return theGKL800ModelPackage;
	}
	 ...
	 */
	@Override
	public GKL800ModelFactory getGKL800ModelFactory() {
		return (GKL800ModelFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(pEClass, GKL800Model.P.class, "P", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getP_P_a_T_x(), this.getT(), null, "P_a_T_x", null, 0, 1, GKL800Model.P.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getP_P_a_T_y(), this.getT(), null, "P_a_T_y", null, 0, 1, GKL800Model.P.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(tEClass, GKL800Model.T.class, "T", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getT_T_x_K_a(), this.getK(), null, "T_x_K_a", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_x_u(), this.getU_s(), null, "T_x_u", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_x_p(), this.getP_s(), null, "T_x_p", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_y_K_a(), this.getK(), null, "T_y_K_a", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_y_u(), this.getU_s(), null, "T_y_u", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getT_T_y_p(), this.getP_s(), null, "T_y_p", null, 0, 1, GKL800Model.T.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(kEClass, GKL800Model.K.class, "K", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
