 ...
 * </p>
 * <ul>
 *   <li>{@link GKL800Model.impl.TImpl#getT_x_K_a <em>TxKa</em>}</li>
 *   <li>{@link GKL800Model.impl.TImpl#getT_x_u <em>Txu</em>}</li>
 *   <li>{@link GKL800Model.impl.TImpl#getT_x_p <em>Txp</em>}</li>
 *   <li>{@link GKL800Model.impl.TImpl#getT_y_K_a <em>TyKa</em>}</li>
 *   <li>{@link GKL800Model.impl.TImpl#getT_y_u <em>Tyu</em>}</li>
 *   <li>{@link GKL800Model.impl.TImpl#getT_y_p <em>Typ</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TImpl extends AgentImpl implements T {
	...
	protected EClass eStaticClass() {
		return GKL800ModelPackage.Literals.T;
	}
		...
		if (t_x_K_a != null && t_x_K_a.eIsProxy()) {
			...
			if (t_x_K_a != oldT_x_K_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TXKA, oldT_x_K_a,
							t_x_K_a));
			}
		}
		return t_x_K_a;
	...
	public void setT_x_K_a(K newT_x_K_a) {
		...
		t_x_K_a = newT_x_K_a;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TXKA, oldT_x_K_a, t_x_K_a));
	}
	...
	public U_s getT_x_u() {
		if (t_x_u != null && t_x_u.eIsProxy()) {
			...
			if (t_x_u != oldT_x_u) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TXU, oldT_x_u,
							t_x_u));
			}
		}
		return t_x_u;
	...
	public void setT_x_u(U_s newT_x_u) {
		...
		t_x_u = newT_x_u;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TXU, oldT_x_u, t_x_u));
	}
	...
	public P_s getT_x_p() {
		if (t_x_p != null && t_x_p.eIsProxy()) {
			...
			if (t_x_p != oldT_x_p) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TXP, oldT_x_p,
							t_x_p));
			}
		}
		return t_x_p;
	...
	public void setT_x_p(P_s newT_x_p) {
		...
		t_x_p = newT_x_p;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TXP, oldT_x_p, t_x_p));
	}
	...
	public K getT_y_K_a() {
		if (t_y_K_a != null && t_y_K_a.eIsProxy()) {
			...
			if (t_y_K_a != oldT_y_K_a) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TYKA, oldT_y_K_a,
							t_y_K_a));
			}
		}
		return t_y_K_a;
	...
	public void setT_y_K_a(K newT_y_K_a) {
		...
		t_y_K_a = newT_y_K_a;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TYKA, oldT_y_K_a, t_y_K_a));
	}
	...
	public U_s getT_y_u() {
		if (t_y_u != null && t_y_u.eIsProxy()) {
			...
			if (t_y_u != oldT_y_u) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TYU, oldT_y_u,
							t_y_u));
			}
		}
		return t_y_u;
	...
	public void setT_y_u(U_s newT_y_u) {
		...
		t_y_u = newT_y_u;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TYU, oldT_y_u, t_y_u));
	}
	...
	public P_s getT_y_p() {
		if (t_y_p != null && t_y_p.eIsProxy()) {
			...
			if (t_y_p != oldT_y_p) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GKL800ModelPackage.T__TYP, oldT_y_p,
							t_y_p));
			}
		}
		return t_y_p;
	...
	public void setT_y_p(P_s newT_y_p) {
		...
		t_y_p = newT_y_p;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GKL800ModelPackage.T__TYP, oldT_y_p, t_y_p));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GKL800ModelPackage.T__TXKA:
			if (resolve)
				return getT_x_K_a();
			return basicGetT_x_K_a();
		case GKL800ModelPackage.T__TXU:
			if (resolve)
				return getT_x_u();
			return basicGetT_x_u();
		case GKL800ModelPackage.T__TXP:
			if (resolve)
				return getT_x_p();
			return basicGetT_x_p();
		case GKL800ModelPackage.T__TYKA:
			if (resolve)
				return getT_y_K_a();
			return basicGetT_y_K_a();
		case GKL800ModelPackage.T__TYU:
			if (resolve)
				return getT_y_u();
			return basicGetT_y_u();
		case GKL800ModelPackage.T__TYP:
			if (resolve)
				return getT_y_p();
